...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { level: @level.level, start_date: @level.start_date, user_id: @level.user_id } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { level: @level.level, start_date: @level.start_date, user_id: @level.user_id } }
