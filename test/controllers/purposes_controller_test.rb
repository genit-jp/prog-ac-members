...
class PurposesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purpose" do
    assert_difference('Purpose.count') do
      post purposes_url, params: { purpose: { result: @purpose.result, text: @purpose.text, title: @purpose.title, user_id: @purpose.user_id } }
    end
  ...
  test "should update purpose" do
    patch purpose_url(@purpose), params: { purpose: { result: @purpose.result, text: @purpose.text, title: @purpose.title, user_id: @purpose.user_id } }
