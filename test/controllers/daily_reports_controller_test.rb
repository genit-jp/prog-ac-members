...
class DailyReportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_report" do
    assert_difference('DailyReport.count') do
      post daily_reports_url, params: { daily_report: { id: @daily_report.id, slack_user_id: @daily_report.slack_user_id, team: @daily_report.team, text: @daily_report.text, ts: @daily_report.ts, user_id: @daily_report.user_id } }
    end
  ...
  test "should update daily_report" do
    patch daily_report_url(@daily_report), params: { daily_report: { id: @daily_report.id, slack_user_id: @daily_report.slack_user_id, team: @daily_report.team, text: @daily_report.text, ts: @daily_report.ts, user_id: @daily_report.user_id } }
